  ...
  return (
    ...
    <Tab.Screen name="Home" component={AppHome}
      ...
      options={{
        ...
        headerShown: true,
        header: () => <SafeAreaView style={{ backgroundColor: 'white' }}>
          <View style={{ flexDirection: "row", paddingHorizontal: 20, justifyContent: "space-between" }}>
            <TouchableOpacity>
              
            <View style={{ flexDirection: 'row', paddingVertical:8,}}>
              <Image source={require('../assets/download.png')} style={styles.profImage} />
              <View style={{ marginLeft:10}}>
            <Text style={{ fontSize: 15, fontWeight: '400', color: 'grey' }}>Welcome Back!</Text>
            <Text style={{ fontSize: 20, fontWeight: '600', color: 'black' }}>Qvelo</Text>
              </View>
            </View>
            </TouchableOpacity>
          ...
          <Ionicons name="ios-notifications-outline" size={22} color='black'/>
